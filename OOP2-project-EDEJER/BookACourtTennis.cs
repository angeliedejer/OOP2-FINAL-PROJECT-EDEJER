...
using static OOP2_project_EDEJER.BookACourtTennis;
...
{
    public partial class BookACourtTennis : Form
    {
        private string selectedMunicipality;
        private GMapOverlay markersOverlay;
        private string username;
        public BookACourtTennis(string username)
        {
            InitializeComponent();
        ...
        private void LoadMap()
        {
            ...
            MarkTennisCourts(selectedMunicipality);
        }
        private void MarkTennisCourts(string municipality)
        {
            ...
            string query = "SELECT Name, CourtAddress, Latitude, Longitude, Availability FROM Courts WHERE Municipality = ? AND SportType = 'Tennis'";
            ...
            {
                MessageBox.Show("Error loading tennis courts: " + ex.Message);
            }
        }
        ...
        private void btnProceedBookingDetails_Click(object sender, EventArgs e)
        {
            ...
            DisplayBookedCourtsInformation(txtCourtName.Text, "Tennis");
        }
        ...
        private void btnBookTennisCourt_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (OleDbCommand command = new OleDbCommand(query, connection))
                {
                    ...
                    command.Parameters.AddWithValue("@sportType", "Tennis");
                ...
                using (OleDbCommand command = new OleDbCommand(query, connection))
                {
                    ...
                    using (OleDbDataReader reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            dataGridViewBookedCourts.Rows.Add(sportType, courtName, bookedNumberOfCourts, selectedCourtNumbers, bookedStartingTime, bookedEndingTime, bookedDate);
                        }
                    }
                }
            }
